...
# Calcular error relativo y porcentual del tiempo>
error_rel_t = tiempo_error / tiempo_prom
error_porc_t = error_rel_t * 100
# Imprimir resultado de lo anterior:
print("Error relativo del tiempo (t):", round(error_rel_t, 4))
print("Error porcentual del tiempo (t):", round(error_porc_t, 2),"%")
